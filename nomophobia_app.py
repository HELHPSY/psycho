...
questions = [
    ...
    "هل ترى نفسك لديك ارتباط مرضي بالهاتف "
]
...
with tab1[0]:
    st.html("<p style='letter-spacing:1px'>استطلاع راي في اطار دراسة مصغرة حول تأثير التطور الرقمي على الصحة النفسية للافراد نرجو ملء هذه الإستمارة و شكرا جزيلا لكم</p>")
